<x-section class="md:flex-row md:space-x-8">
  <img
    ...
    alt="That's me"
    class="border-2 border-primary-800 dark:border-primary-100 js-tippy hidden md:block xs-h:block object-cover object-center rounded-full h-44 w-44 sm:h-56 sm:w-56 my-4">
